...
const translations = {
  en: {
    ...
    hero_title: "A Modern Oasis of Peace and Luxury",
    hero_text: "Villa Posija offers a perfect blend of elegance, comfort, and complete privacy in the idyllic village of Kras. Enjoy beautiful nature far away from city noise.",
  ...
  hr: {
    ...
    hero_text: "Villa Posija nudi savršen spoj elegancije, udobnosti i potpune privatnosti u idiličnom mjestu Kras. Uživajte u predivnoj prirodi daleko od gradske buke.",
  ...
  de: {
    ...
    hero_title: "Eine moderne Oase der Ruhe und des Luxus",
    hero_text: "Die Villa Posija bietet eine perfekte Mischung aus Eleganz, Komfort und absoluter Privatsphäre im idyllischen Dorf Kras. Genießen Sie die wunderschöne Natur fernab vom Stadtlärm.",
  ...
  it: {
    ...
    hero_title: "Una moderna oasi di pace e lusso",
    hero_text: "Villa Posija offre un perfetto connubio tra eleganza, comfort e totale privacy nell'idilliaco villaggio di Kras. Godetevi la splendida natura lontano dal rumore della città.",
